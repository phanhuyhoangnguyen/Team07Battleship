...
static class UtilityFunctions
{
	...
	int cellGap)
	{
		...
		for (int row = 0; row <= 9; row++) {
			...
			for (int col = 0; col <= 9; col++) {
                ...
                Color fillColor = Color.DarkBlue;
				bool draw = false;
				...
				case TileView.Ship:
					if (grid.Item (row, col) == TileView.Ship && small)
					{
						fillColor = SMALL_SEA;
					} else
						draw = false;
	...
	private static List<Sprite> _Animations = new List<Sprite>();
  	...
  	/// <summary>
	/// Show animation on the specified coordinate of the game.
	/// </summary>
	/// <param name="row">the y coordinate for the animation</param>
	/// <param name="col">the x coordinate for the animation</param>
    ...
    /// <summary>
	/// Update the animation according to the sprites.
	/// </summary>
    ...
    /// <summary>
	/// Draw the animation images on the stage.
	/// </summary>
    ...
    /// <summary>
	/// Update and draw the animation on the stage.
	/// </summary>
