...
static class HighScoreController
{
    ...
    /// Where NNN is the name and SSS is the score
    /// </remarks>
    private static void SaveScores(String filenames)
    {
    ...
    public static void DrawHighScores()
    {
        ...
        SwinGame.DrawBitmap(GameResources.GameImage("BackButton"), 30, 75);
    }
    ...
    public static void HandleHighScoreInput()
    {
        ...
        //Add the input handler if the player click at the posisition of the button
        if (SwinGame.MouseClicked(MouseButton.LeftButton))
        {
            if (UtilityFunctions.IsMouseInRectangle(30, 75, 607, 72))
            {
